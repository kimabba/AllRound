...
insert into public.regions(code, display_name_ko, governing_associations, uses_kato, uses_kata, notes) values
  ...
  ('seoul', '서울', ARRAY['KTA-서울','KATA','KATO'], true, true,
   '서울. 전국 단위 협회 다수.'),
  ('gyeonggi', '경기', ARRAY['KTA-경기','KATA','KATO'], true, true,
   '경기도. 전국 단위 협회 다수.'),
  ('incheon', '인천', ARRAY['KTA-인천','KATA','KATO'], true, true,
   '인천. 전국 단위 협회 다수.'),
  ('seoul_metro', '수도권', ARRAY['KTA-서울','KTA-경기','KTA-인천'], true, true,
   '레거시 호환 코드. 신규 온보딩 저장에는 서울·경기·인천 세부 코드를 사용.'),
