...
### 콘텐츠·심사 정책
- [ ] **UGC 안전장치** (JY-115): ① 부적절 콘텐츠 신고 ② 사용자 차단 ③ 콘텐츠 필터/모더레이션 ④ EULA ⑤ 지원 연락처. 클럽 게시판 + AI 채팅 모두 해당. **미구현 시 Apple 1.2 / Play UGC 정책 리젝.**
- [ ] **AI 생성 콘텐츠 고지** — 코치봇이 AI 생성임을 표시 + 부적절 응답 신고 경로 (Play "AI-Generated Content" 정책)
