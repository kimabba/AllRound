...
| 준비 중 버전 | `1.1.0 (7)` | 코드 반영 완료, App Store Connect 업로드 대기 |
...
2026-09-03: 빌드 6은 App Store Connect에 업로드되지 않았고 그 사이 PR 58건이 더 쌓여
`1.1.0+7`로 갱신했다(`appBuildNumber`도 `7`).
...
| `1.1.0` | `6` | 미업로드·7로 대체 | — | PR #438 | 빌드 5 이후 54커밋. 업로드 전에 PR 58건이 더 쌓여 빌드 7로 갱신 |
| `1.1.0` | `7` | 코드 준비 완료 | — | — | 약관·처리방침 주소를 all-round.it.kr 로 교체. App Store Connect 업로드 대기 |
