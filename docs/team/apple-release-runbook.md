...
| 준비 중 버전 | `1.1.0 (6)` | 코드 반영 완료, App Store Connect 업로드 대기 |
...
| Flutter 표기 | `1.1.0+6` | 사용자 버전과 빌드번호를 함께 기록 |
...
1. 목표 버전과 빌드번호를 먼저 정한다. 예: `1.1.0+6`.
...
2. App Store 버전에 `1.1.0` 같은 사용자 버전을 입력한다.
