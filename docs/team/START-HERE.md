...
| 🔴 | JY-112 회원 탈퇴(계정 삭제) | **[드론]** | 스토어 **제출 필수 요건**, due 7/14 |
...
| ✅결정 | 애플 로그인 **생략** | **[kimabba]** | 이메일 로그인 제공으로 애플 4.8 면제 판단(카카오/구글+이메일). 리젝 시 재검토 |
...
- **제출 크리티컬**: JY-112 회원 탈퇴(필수) · JY-113 구글 세션 버그 · JY-7 카카오 · JY-68 식별자 · Sign in with Apple 확인
- **다음 큰 덩어리**: 스토어 에셋(JY-1), 메타데이터·릴리스(JY-6)
